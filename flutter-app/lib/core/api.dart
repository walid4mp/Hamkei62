...
class Api {
  ...
  static Future<void> comment(String id, String body) async =>
      req('POST', '/api/posts/$id/comments', body: {'body': body});
  ...
  static Future<void> post(String caption,
      {String media = '', String type = 'TEXT', String music = '', String visibility = 'PUBLIC', String title = '', int rotationDegrees = 0, String overlayText = '', String overlayEmoji = '', String overlayImageUrl = ''}) async {
    await req('POST', '/api/posts', body: {
      'caption': caption, 'mediaUrl': media, 'type': type, 'musicTitle': music,
      'visibility': visibility, 'title': title, 'rotationDegrees': rotationDegrees,
  ...
  static Future<void> createReel(String videoUrl, String caption, String music, {String musicUrl = '', String title = '', int rotationDegrees = 0, String overlayText = '', String overlayEmoji = '', String overlayImageUrl = ''}) async =>
      req('POST', '/api/reels', body: {
        'videoUrl': videoUrl, 'caption': caption, 'musicUrl': musicUrl, 'musicTitle': music, 'title': title,
        'rotationDegrees': rotationDegrees, 'overlayText': overlayText, 'overlayEmoji': overlayEmoji, 'overlayImageUrl': overlayImageUrl,
      });
  ...
  static Future<Map<String,dynamic>> commentReel(String id,String body) async => Map<String,dynamic>.from(await req('POST','/api/reels/$id/comments',body:{'body':body}));
  ...
  static Future<void> createStory(String mediaUrl, String type, String caption, {int rotationDegrees = 0, String overlayText = '', String overlayEmoji = '', String overlayImageUrl = '', String musicUrl = '', String musicTitle = ''}) async =>
      req('POST', '/api/stories', body: {'mediaUrl': mediaUrl, 'type': type, 'caption': caption, 'rotationDegrees': rotationDegrees, 'overlayText': overlayText, 'overlayEmoji': overlayEmoji, 'overlayImageUrl': overlayImageUrl, 'musicUrl': musicUrl, 'musicTitle': musicTitle});
  ...
  static Future<void> follow(String id) async => req('POST', '/api/users/$id/follow');
  ...
  static Future<void> sendMessage(String userId, String body, {bool secret = false, bool selfDestruct = false, int ttlMinutes = 60, int viewLimit = 0}) async =>
      req('POST', '/api/messages/$userId', body: {'body': body, 'secret': secret, 'selfDestruct': selfDestruct, 'ttlMinutes': ttlMinutes, 'viewLimit': viewLimit});
