    ...
    if (_failed) {
      return Container(
        ...
        child: Column(
          ...
          children: [
            Icon(Icons.videocam_off_outlined, color: SN.textMut),
            const SizedBox(height: 8),
            Text(_errorText, style: TextStyle(color: SN.textSec, fontSize: 12)),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(text, textAlign: TextAlign.center, style: TextStyle(color: SN.textSec)),
            ],
          ),
        ),
      );
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: Row(
          children: [
            Container(
              width: 34, height: 34,
              decoration: BoxDecoration(shape: BoxShape.circle, gradient: SN.grad),
