...
class _AuthScreenState extends State<AuthScreen> with SingleTickerProviderStateMixin {
          ...
          children: [
            const Row(
              children: [
                ...
                SizedBox(width: 8),
                Text('تعذّر الوصول إلى الخادم', style: TextStyle(color: SN.gold, fontWeight: FontWeight.w700)),
              ],
            ),
            const SizedBox(height: 6),
            Text('العنوان الحالي: ${Api.baseUrl}',
                style: const TextStyle(color: SN.textSec, fontSize: 11), textDirection: TextDirection.ltr),
            Row(children: [
  ...
  List<Widget> _loginForm() => [
        ...
        const SizedBox(height: 4),
        const Text('سجّل الدخول إلى حسابك', style: TextStyle(color: SN.textSec, fontSize: 13)),
        const SizedBox(height: 20),
        TextField(
        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            prefixIcon: const Icon(Icons.lock_outline, color: SN.textSec),
        ...
        Row(
          ...
          children: [
            const Text('ليس لديك حساب؟', style: TextStyle(color: SN.textSec)),
            TextButton(
  ...
  List<Widget> _registerForm() => [
        ...
        TextField(
          controller: nameCtrl,
          textInputAction: TextInputAction.next,
          decoration: const InputDecoration(labelText: 'الاسم الكامل', prefixIcon: Icon(Icons.person_outline, color: SN.textSec)),
        ),
        const SizedBox(height: 12),
        TextField(
          controller: userCtrl,
        ...
        TextField(
          ...
          keyboardType: TextInputType.emailAddress,
          textInputAction: TextInputAction.next,
          decoration: const InputDecoration(labelText: 'البريد الإلكتروني', prefixIcon: Icon(Icons.mail_outline, color: SN.textSec)),
        ),
        const SizedBox(height: 12),
        TextField(
          controller: passCtrl,
        ...
        Align(
          ...
          child: Text('الجنس', style: TextStyle(color: SN.textSec, fontSize: 13)),
        ),
        ...
        Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            const Text('لديك حساب؟', style: TextStyle(color: SN.textSec)),
            TextButton(
