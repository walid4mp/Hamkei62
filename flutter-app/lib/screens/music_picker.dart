...
class _MusicPickerState extends State<_MusicPicker> {
  ...
  Future<void> _preview(Map<String, dynamic> t) async {
    ...
    try {
      ...
      if (mounted) ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('تعذر تشغيل المعاينة')));
    }
  }
      ...
      child: SizedBox(
        ...
        child: Padding(
          ...
          child: Column(children: [
            ...
            Row(children: [
              const Expanded(child: Text('🎵 موسيقى SocialNova', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w900))),
