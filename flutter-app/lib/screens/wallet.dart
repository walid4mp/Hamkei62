              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: [
                    ...
                    DropdownMenuItem(value: 'BANK', child: Text(L10n.t('حساب بنكي'))),
                    DropdownMenuItem(value: 'OTHER', child: Text(L10n.t('طريقة أخرى'))),
                  ],
                ...
                const SizedBox(height: 10),
                Text('يُخصم رسم السحب من قيمة الرصيد قبل التحويل النقدي.', style: TextStyle(fontSize: 11, color: SN.textMut)),
              ],
            ),
          ),
          actions: [
