...
class _WomenHubPageState extends State<WomenHubPage> {
        ...
        children: [
          Container(
            ...
            child: const Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text('مساحة آمنة ومجتمعية 🌸', style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.w800)),
              SizedBox(height: 8),
              Text('اكتشفي محتوى حسب اهتماماتك، شاركي أفكارك وتواصلي باحترام وخصوصية.', style: TextStyle(color: Colors.white, height: 1.4)),
            ]),
          ),
          ...
          const Text('الأقسام', style: TextStyle(fontSize: 19, fontWeight: FontWeight.w800, color: SN.textPri)),
          ...
          const Text('ميزات المجتمع', style: TextStyle(fontSize: 19, fontWeight: FontWeight.w800, color: SN.textPri)),
          const SizedBox(height: 10),
  ...
  Widget _feature(IconData icon, String title, String sub) => Card(child: ListTile(leading: Icon(icon, color: SN.cyan), title: Text(title, style: const TextStyle(fontWeight: FontWeight.w700)), subtitle: Text(sub)));
