...
class _MaximumPrivacyPageState extends State<MaximumPrivacyPage> {
  ...
  Widget _sw(String title,String sub,bool value,ValueChanged<bool> onChanged)=>SwitchListTile.adaptive(contentPadding:EdgeInsets.zero,title:Text(title,style:TextStyle(fontWeight:FontWeight.w700)),subtitle:Text(sub,style:TextStyle(fontSize:12,color:SN.textMut)),value:value,onChanged:onChanged);
  @override
    ...
    return Scaffold(
      ...
      body: loading ? const LoadingBox() : ListView(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          Text('ملاحظة أمنية: منع لقطات الشاشة يعتمد على حماية نظام التشغيل ولا يمنع كل طرق النسخ.', style: TextStyle(fontSize: 12, color: SN.textMut)),
